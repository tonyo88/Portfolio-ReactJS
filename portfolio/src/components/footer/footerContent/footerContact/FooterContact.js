    ...
    <div className="footer-contact-container">
      <div className="contact-info">
        <p>
          ...
          <br />
          <strong className="footer-title">Phone: </strong>
          <a className="footer-contact-link" href="tel:+1-310-923-0276">
            +1.310.923.0276
          </a>
          <br />
          <strong className="footer-title">Email: </strong>
          <a
            className="footer-contact-link"
            href="mailto:tonyo_vanov@yahoo.com"
          >
